                                        ...
                                        if (valor["ID_EDIFICIO COD. SIGUA"] == value.id + " ") {
                                           ...
                                           /* console.log("yeeeeeeeeeeeeeeeeeeeeeeeee");
                                            ...
                                            var contentString = '<div id="content">' +
                                                '<div id="siteNotice">' +
                                                '</div>' +
                                                '<h1 id="firstHeading" class="firstHeading">' + valor.EDIFICIO + '</h1>' +
                                                '<div id="bodyContent">' +
                                                '<p id="codigo"> CÓDIGO SIGUA:' + valor["ID_EDIFICIO COD. SIGUA"] + '</p>'+
                                                '<p> AGUA 1,5L: ' + valor["AGUA 1,5L"] + '</p><p> COMIDA SALUDABLE:' + valor["COMIDA SALUDABLE"] + '</p>' +
                                                '<p> CAFETERÍA: ' + valor.CAFETERA + '</p>' +
                                                '<p> SÓLIDOS:' + valor["SÓLIDOS"] + '</p>' +
